...
import { Brain, LogIn, UserPlus, AlertCircle, CheckCircle, Briefcase } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">HR & Recruiting Platform</p>
        </div>
        ...
        <Card className="shadow-lg border-0">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Sign in to your account or create a new one to start screening resumes with AI
            </CardDescription>
          </CardHeader>
